    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center mx-auto">
            ...
            <form className="container mx-auto px-4 flex flex-col gap-3 max-w-sm md:max-w-md lg:max-w-lg">
                <input className="w-full p-2 rounded-md border border-accent2" required type="email" placeholder="Email" />
                <input className="w-full p-2 rounded-md border border-accent2" required type="password" placeholder="Password" />
